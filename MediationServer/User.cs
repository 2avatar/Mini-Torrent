...
namespace MediationServer
{
    public class User
    {
        ...
        public User(List<File> listOfFiles)
        {
            ...
            foreach (File f in listOfFiles)
            {
                ...
                addFileNameAttribute(f.getFileName());
                addFileSizeAttribute(f.getFileSize().ToString());
                addFileNumberOfActiveUsers(f.getNumberOfActiveUser().ToString());
            }
        }
        ...
        public User(string username, string password, List<File> listOfFiles)
        {
            createUserElementXML();
            addUsernameAttribute(username);
            addPasswordAttribute(password);
        ...
        public User(string username, string password, string IP, string PORT, List<File> listOfFiles)
        {
            createUserElementXML();
            addUsernameAttribute(username);
            addPasswordAttribute(password);
